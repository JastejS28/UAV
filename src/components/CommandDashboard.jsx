...
<Paper elevation={3} sx={{ p: 2, mb: 2 }}>
  ...
  <Paper sx={{ p: 1.5, mb: 1.5, bgcolor: '#ffebee', color: '#000' }}>
    ...
    <Box sx={{ mt: 1 }}>
      ...
      <Typography variant="body2">
        <strong>Size:</strong> Larger than jeeps, rectangular base with rotating top
      </Typography>
      <Typography variant="body2">
  ...
  <Paper sx={{ p: 1.5, mb: 1.5, bgcolor: '#e8f5e9', color: '#000' }}>
    ...
    <Box sx={{ mt: 1 }}>
      ...
      <Typography variant="body2">
        <strong>Size:</strong> Smaller than tanks, light-duty vehicle profile
      </Typography>
      <Typography variant="body2">
  ...
  <Paper sx={{ p: 1.5, mb: 1.5, bgcolor: '#fff3e0', color: '#000' }}>
    ...
    <Box sx={{ mt: 1 }}>
      ...
      <Typography variant="body2">
        <strong>Size:</strong> Largest object, fixed structure with distinct shape
      </Typography>
      <Typography variant="body2">
  ...
  <Paper sx={{ p: 1.5, mb: 1.5, bgcolor: '#f3e5f5', color: '#000' }}>
    ...
    <Box sx={{ mt: 1 }}>
      ...
      <Typography variant="body2">
        <strong>Size:</strong> Smallest target, may be difficult to spot from high altitude
      </Typography>
      <Typography variant="body2">
  ...
  <Box sx={{ mt: 2, p: 1.5, bgcolor: 'rgba(0,0,0,0.2)', borderRadius: 1 }}>
    ...
    <Typography variant="body2">
      • Click directly on suspected targets to investigate
    </Typography>
  </Box>
</Paper>
